...
Visit the [plugin homepage](https://sheabunge.com/plugins/personal-email/), or contribute to its development on [GitHub](https://github.com/sheabunge/personal-email).
